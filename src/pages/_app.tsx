...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return (
    ...
    >
      <Head>
        <title>Sports Central - Live Sports Predictions, Scores & Community</title>
        <meta name="description" content="Free AI-powered sports predictions for NFL, NBA, MLB, Soccer. Live scores, interactive quizzes, community forum, and earn Pi coins. Join 1000+ sports fans!" />
        <meta name="keywords" content="sports predictions, live scores, NFL predictions, NBA predictions, MLB predictions, soccer predictions, sports betting, sports quiz, sports community, Pi coin rewards" />
        ...
        <meta property="og:title" content="Sports Central - Live Sports Predictions & Community" />
        <meta property="og:description" content="Free AI-powered sports predictions for NFL, NBA, MLB, Soccer. Live scores, interactive quizzes, community forum, and earn Pi coins!" />
        ...
        <meta name="twitter:title" content="Sports Central - Live Sports Predictions & Community" />
        <meta name="twitter:description" content="Free AI-powered sports predictions for NFL, NBA, MLB, Soccer. Live scores, interactive quizzes, community forum, and earn Pi coins!" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebApplication",
              "name": "Sports Central",
              "description": "Free AI-powered sports predictions for NFL, NBA, MLB, Soccer. Live scores, interactive quizzes, community forum, and earn Pi coins.",
